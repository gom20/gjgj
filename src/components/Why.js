            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="why">
                <section id="why">
                    <div className="problem-container">
                        <div className="title">이러한 고민을 해결해드립니다.</div>
                        <div className="item-wrap">
                            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                                <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                                    <Typography>1. 한 건 많은데, 나의 이야기를 정리하기 힘들어요</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                                        오래도록 업무를 해와서 한 건 많은데, 막상 한 일들을 글로 정리하는 게 어렵다는 분들이 많습니다. 여기서 중요한
                                        것은, 하고 싶은 이야기와 읽고 싶은 이야기는 다르다는 겁니다. 글적글적연구소에서는 그 포인트를 정확하게 짚어서
                                        개요부터 함께 고민하는 시간을 가집니다.
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
                            ...
                            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                                <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
                                    <Typography>2. 나를 알리는 글을 쓰는 방법이 따로 있나요?</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                            ...
                            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                                <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                                    <Typography>3. 브랜딩하고 싶은데, 방법을 모르겠어요ㅠ</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                                        원 소스 멀티 유즈. 하나의 콘텐츠로 여러 채널에 뿌리라는 말을 많이 합니다. 시간과 비용을 최소화하는 일은 언제나
                                        중요하니까요. 앞으로 어떤 방향으로 나아가고 싶은지, 지금까지 해온 일들을 앞으로 하고 싶은 일과 어떻게
                                        자연스럽게 연결할 수 있는지, 내가 원하는 나의 모습은 무엇인지. 깊게 고민해주세요. 방향은 이곳에서
                            ...
                            <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                                <AccordionSummary aria-controls="panel4d-content" id="panel4d-header">
                                    <Typography>4. 브랜딩이 소득으로 연결될 수 있을까요?</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                                        이미 글적글적연구소에서 함께한 분들 중 소득 창출하고 하고 계신 분들이 많습니다. 원고작가, 디자이너, 강사 등.
                                        오래도록 프리랜서로 일해왔기에 갖고있는 네트워크로 조금 더 수월하게 시작할 수 있도록 돕겠습니다. 이곳에서
                                        출발선을 앞당겨보세요.
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
                            ...
                            <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                                <AccordionSummary aria-controls="panel5d-content" id="panel5d-header">
                                    <Typography>5. 이 강의를 들어야 할지 아직 확신이 없습니다. </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
