            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
                <section id="why">
                            ...
                            <motion.div
                                ...
                                <div className="item-wrap">
                                    ...
                                    <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                                        ...
                                        <AccordionDetails>
                                            <Typography>
                                                수많은 블로그 글쓰기 강의가 있지만, 맛집을 소개해서 방문자수만 많게 만드는 것이 능사는 아닙니다.
                                                브랜딩을 위해서는 많은 사람들이 스쳐&apos;나의 업무&apos;를 소개하는 글이어야 합니다. 나의 SNS에 매일
                                                찾아오고 오래 머무는 팬을 만들어야 합니다.
                                            </Typography>
                                        </AccordionDetails>
                                    </Accordion>
                                    ...
                                    <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                                        ...
                                        <AccordionDetails>
                                            <Typography>
                                                원 소스 멀티 유즈. 하나의 콘텐츠로 여러 채널에 뿌리라는 말을 많이 합니다. 시간과 비용을 최소화하는
                                                일은 언제나 중요하니까요. 앞으로 어떤 방향으로 나아가고 싶은지, 지금까지 해온 일들을 앞으로 하고 싶은
                                                일과 어떻게 자연스럽게 연결할 수 있는지, 내가 원하는 나의 모습은 무엇인지. 깊게 고민해주세요. 방향은
                                                이곳에서 제시해드립니다. 가장 효율적인 방법으로요.
                                            </Typography>
                                        </AccordionDetails>
                                    </Accordion>
                                    ...
                                    <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                                        ...
                                        <AccordionDetails>
                                            <Typography>
                                                이미 글적글적연구소에서 함께한 분들 중 소득 창출하고 하고 계신 분들이 많습니다. 원고작가, 디자이너,
                                                강사 등. 오래도록 프리랜서로 일해왔기에 갖고있는 네트워크로 조금 더 수월하게 시작할 수 있도록
                                                돕겠습니다. 이곳에서 출발선을 앞당겨보세요.
                                            </Typography>
                                        </AccordionDetails>
                                    </Accordion>
                                    ...
                                    <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                                        ...
                                        <AccordionDetails>
                                            <Typography>
                                                ...
                                                필요하니까요. 하지만 이곳에서 함께 쓰는 글들이, 사골처럼 두고두고 우려먹을 수 있는 액기스가 될
                    ...
                    <div className="point-container">
                        <div className="sub-title">이것만은 알아두자</div>
                        <motion.div
                            className="title"
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
